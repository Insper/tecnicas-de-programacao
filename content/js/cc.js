...
var F = {procname: "module dom", prev: framePtr, filename: "/usr/lib64/nim/lib/js/dom.nim", line: 0};
framePtr = F;
framePtr = F.prev;
var F = {procname: "module dom", prev: framePtr, filename: "/usr/lib64/nim/lib/js/dom.nim", line: 0};
framePtr = F;
...
function auxWriteStackTrace_33556508(f_33556509) {
  var result_33556510 = [[]];
    ...
    Label5: {
      var j_33556554 = 0;
      var colontmp__520093884 = 0;
      colontmp__520093884 = (i_33556519 - 1);
      var res_520093886 = colontmp__520093884;
      Label6: {
          Label7: while (true) {
          if (!(0 <= res_520093886)) break Label7;
            j_33556554 = res_520093886;
...
function newSeq_33556919(len_33556921) {
  ...
  var F = {procname: "newSeq.newSeq", prev: framePtr, filename: "/usr/lib64/nim/lib/system.nim", line: 0};
  framePtr = F;
    F.line = 635;
...
function addChars_301990090(result_301990092, result_301990092_Idx, x_301990093, start_301990094, n_301990095) {
  ...
  var F = {procname: "addChars.addChars", prev: framePtr, filename: "/usr/lib64/nim/lib/std/private/digitsutils.nim", line: 0};
  framePtr = F;
    F.line = 43;
    ...
    Label2: {
      ...
      Label3: {
        F.line = 120;
          Label4: while (true) {
          if (!(i_520093879 < n_301990095)) break Label4;
            F.line = 49;
            F.filename = "digitsutils.nim";
            iHEX60gensym4_301990110 = i_520093879;
            F.line = 49;
...
function addInt_301990111(result_301990112, result_301990112_Idx, x_301990113) {
  var F = {procname: "digitsutils.addInt", prev: framePtr, filename: "/usr/lib64/nim/lib/std/private/digitsutils.nim", line: 0};
  framePtr = F;
    F.line = 111;
    F.filename = "digitsutils.nim";
...
function HEX24_369098760(x_369098761) {
  ...
  var F = {procname: "dollars.$", prev: framePtr, filename: "/usr/lib64/nim/lib/system/dollars.nim", line: 0};
  framePtr = F;
    F.line = 18;
...
function tabIndents_520093698(e_520093699) {
  var F = {procname: "nim_components.tabIndents", prev: framePtr, filename: "/home/deck/Documents/nim-components/src/nim_components.nim", line: 0};
  framePtr = F;
    F.line = 4;
    F.filename = "nim_components.nim";
    var kEvt_520093700 = e_520093699;
    F.line = 5;
    var el_520093701 = kEvt_520093700.target;
    F.line = 7;
    if (    kEvt_520093700.keyCode == 9    ){      F.line = 9;
      kEvt_520093700.preventDefault();
      F.line = 10;
      var el_520093702 = kEvt_520093700.target;
      F.line = 11;
      el_520093702.setRangeText("\t", el_520093702.selectionStart, el_520093702.selectionEnd, "end");
      }
    else if (    kEvt_520093700.keyCode == 13    ){      F.line = 13;
      kEvt_520093700.preventDefault();
      F.line = 14;
      el_520093701.setRangeText("\t", el_520093701.selectionStart, el_520093701.selectionEnd, "end");
      }
    else{
      }
  framePtr = F.prev;
...
function sysFatal_268435501(message_268435504) {
  var F = {procname: "sysFatal.sysFatal", prev: framePtr, filename: "/usr/lib64/nim/lib/system/fatal.nim", line: 0};
  framePtr = F;
    F.line = 53;
...
function raiseAssert_268435499(msg_268435500) {
  var F = {procname: "assertions.raiseAssert", prev: framePtr, filename: "/usr/lib64/nim/lib/std/assertions.nim", line: 0};
  framePtr = F;
    F.line = 36;
...
function failedAssertImpl_268435541(msg_268435542) {
  var F = {procname: "assertions.failedAssertImpl", prev: framePtr, filename: "/usr/lib64/nim/lib/std/assertions.nim", line: 0};
  framePtr = F;
    F.line = 41;
    F.filename = "assertions.nim";
...
var F = {procname: "module nim_components", prev: framePtr, filename: "/home/deck/Documents/nim-components/src/nim_components.nim", line: 0};
framePtr = F;
F.line = 21;
F.filename = "nim_components.nim";
var longExercises_520093751 = document.querySelectorAll(".admonition.long textarea");
Label1: {
  F.line = 23;
  var l_520093774 = [null];
  F.line = 241;
  F.filename = "iterators.nim";
  var i_520093872 = 0;
  F.line = 242;
  var L_520093873 = (longExercises_520093751).length;
  Label2: {
    F.line = 243;
      Label3: while (true) {
      if (!(i_520093872 < L_520093873)) break Label3;
        F.line = 23;
        F.filename = "nim_components.nim";
        l_520093774[0] = longExercises_520093751[chckIndx(i_520093872, 0, (longExercises_520093751).length - 1)];
        F.line = 23;
        l_520093774[0].addEventListener("keydown", tabIndents_520093698, false);
        F.line = 245;
        F.filename = "iterators.nim";
        i_520093872 = addInt(i_520093872, 1);
        if (!(((longExercises_520093751).length == L_520093873))) {
        F.line = 246;
        failedAssertImpl_268435541(makeNimstrLit("/usr/lib64/nim/lib/system/iterators.nim(246, 11) `len(a) == L` the length of the seq changed while iterating over it"));
        }

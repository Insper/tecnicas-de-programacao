...
!!! exercise choice
    ...
    !!! answer
        Nossa ideia diz que a mão direita deve passar por todas paredes e que sempre seguimos em frente. Logo, a primeira opção não pode ocorrer: foi invertido o sentido sem trocar a mão de parede. 

        Gostaríamos de seguir reto, mas não é possível por há uma parede na frente. Logo, devemos mudar a mão de parede, virando para a esquerda e colocando a mão na parede de cima. 

        A terceira opção pulou uma parede e mudou direto para a da esquerda. 
